...
class Register extends React.Component{
    ...
    render(){
        ...
        return (
            <div>
                {this.props.userReducer.redirectTo&&this.props.userReducer.redirectTo!==this.props.location.pathname&&this.props.userReducer.redirectTo!=="/login"? <Redirect to={this.props.userReducer.redirectTo}/>:null}
