  ...
  renderApplicant(){
      return(
          <div>
              ...
              <p className="description text-center">{this.props.userReducer.desc}</p>
              <center>
                  {this.props.userReducer.cvLink?<div><a className="description text-center" href={'https://'+this.props.userReducer.cvLink}>Resume</a><br/></div>:null}
                  {this.props.userReducer.website?<div><a className="description text-center" href={'https://'+this.props.userReducer.website}>My Website</a></div>:null}
                  <br/>
              </center>
